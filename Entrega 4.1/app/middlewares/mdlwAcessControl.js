...
const accesControl = (req, res, next) => {
    ...
    const {username} = req.body;   //<- recoger parámetros por body -> raw , en formato JSON. ¡¡Imprescindible referenciarlo antes con 'app.use(express.json());' en fichero config.js , sino da error aquí!!
